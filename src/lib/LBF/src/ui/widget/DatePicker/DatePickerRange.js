 ...
 * @create 6/23/14
 */
LBF.define('ui.widget.DatePicker.DatePickerRange', function(require, exports, module) {
    var DatePicker = require('ui.widget.DatePicker.DatePicker'),
        extend = require('lang.extend'),
        proxy = require('lang.proxy'),
        Popup = require('ui.Nodes.Popup'),
        dateTool = require('lang.dateTool'),
        datePickerTemplate = require('ui.widget.DatePicker.DatePickerRangeTemplate');
