...
K.options = {
	...
	fonts : {
		...
		formatblock : 'e853',
		source : 'e854',
		/**************这边插入我们自己的菜单, modify by tevinyin************/
		code : 'e855',
		pattern : 'e856'
		/********************************************************************/
	}
	...
	create : function() {
		...
		K.each(self.items, function(i, name) {
			if (name == '|') {
				...
				/*******这边创建的时候需要修改特定的两个菜单项样式，modify by tevinyin*******/
				if(name == 'fullscreen'){
					htmlList.push('<span style="float:right;" class="ke-outline" data-name="' + name + '" title="' + self.lang(name) + '" unselectable="on">');
					htmlList.push('<span class="ke-toolbar-icon ke-icon-' + name + '" unselectable="on">&#x' + self.fonts[name] + ';</span></span>');
				}else if(name == 'copyall'){
					htmlList.push('<span style="float:right;" class="ke-outline" data-name="' + name + '" title="' + self.lang(name) + '" unselectable="on">');
					htmlList.push('<span style="font-size:12px !important;width:48px !important;font-family:\'Microsoft YaHei\' !important;" class="ke-toolbar-icon ke-icon-' + name + '" unselectable="on">' + self.lang(name) + '</span></span>');
				}else{
...
_plugin('core', function(K) {
	...
	self.clickToolbar('fullscreen', function() {
		/**这边的全屏注释掉，外面自己实现一个， modify by tevinyin**/
		/**self.fullscreen();**/
	});
	...
	/*************************这边先出去这些菜单，因为都是web控件实现****************************/
	//_each('link,image,flash,media,anchor'.split(','), function(i, name) {
	_each(''.split(','), function(i, name) {
	/********************************************************************************************/
